...
<?php 
     if (isset($_GET['seenmsgid'])) {
     	...
     	$sentToSeenBox=$pt->sentToSeenBox($SeenMsgId);     	
     }
...
<?php
      ...
      if(isset($_GET['delid'])){
      	...
      	$delid = preg_replace('/[^-a-zA-Z0-9_]/', '', $_GET['delid']);
      	 $delMessage   =$pt->deleteMessage($delid);
      }
        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">        
					...
					<tbody>
						<?php 
						$getALLMessage=$pt->getALLMessage();
						if ($getALLMessage) {
							$i=0;
                ...
                <div class="block">        
					...
					<tbody>
						<?php 
						$getALLSeenMessage=$pt->getALLSeenMessage();
						...
						<tr class="odd gradeX">
							...
							<td><?php echo $result['firstname'].' '.$result['lastname'];?></td>
							<td><?php echo $result['email'];?></td>
							<td><?php echo $fm->validation($result['body']);?></td>
							<td> 
